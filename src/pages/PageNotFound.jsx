...
const PageNotFound = () => {
  return (
    <>   <div className="p-4 for_responsive" style={{ marginLeft: '12rem' }}> <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', height: '100vh', backgroundColor: '#f5f5f5' }}>
