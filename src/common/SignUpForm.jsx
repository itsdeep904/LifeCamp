                ...
                <div style={styles.formContainer}>
                    ...
                    <form style={styles.form}>
                        <div style={styles.inputContainer}>
                            <label style={focused.fullName ? styles.labelFocused : styles.label}>Full Name</label>
                            <input
                                type="text"
                        ...
                        <div style={styles.inputContainer}>
                            <label style={focused.confirmPassword ? styles.labelFocused : styles.label}>Confirm Password</label>
                            <input
                                type="password"
                        ...
                        <Link  onClick={handleSubmit} style={styles.button}>Sign Up</Link>
                        <div style={styles.linksContainer}>
                            <Link to='/LoginForm' style={styles.link}>Already have an account? Login</Link>
                        </div>
                    </form>
                </div>
            </div>
